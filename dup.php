...
// Output address
$pdf->SetX(20);
$pdf->MultiCell(($pdf->GetPageWidth() - 30)/2 - 10, 5, 'Address', 0);
...
$pdf->Cell(($pdf->GetPageWidth() - 60)/2 - 10, 5, "Payroll No: ", 0, 1);
$pdf->SetX($pdf->GetPageWidth()/2 + 30);
$pdf->Cell(($pdf->GetPageWidth() - 60)/2 - 10, 5, "Employment Type: ".$payroll['employment_type'], 0, 1);
...
$pdf->Cell(100, 6, ' AMOUNT:', 0, 0);
$pdf->SetX($pdf->GetPageWidth() - 50);
$pdf->Cell(35, 6, 'GHS ' . number_format($payroll['base_salary'], 2), 0, 1, 'R');
...
$pdf->SetX(15);
$pdf->Cell(100, 6, 'STATUS:', 0, 0);
$pdf->SetX($pdf->GetPageWidth() - 50);
$status = ($payroll <= 0) ? "PAID" : "PARTIAL";
