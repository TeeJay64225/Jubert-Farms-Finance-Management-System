...
<nav class="navbar navbar-dark">
    <div class="container-fluid">
        <span class="navbar-brand d-flex align-items-center">
            ...
            Jubert Farms Finance Manager Dashboard
        </span>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="quick-actions">
            <a href="../manager/manager_sale.php" class="quick-action-btn">
                <i class="fas fa-coins"></i>
                Add Sale
            </a>
            <a href="../manager/manager_expense.php" class="quick-action-btn">
                <i class="fas fa-file-invoice-dollar"></i>
                Add Expense
            </a>
            <a href="../manager/manager_report.php" class="quick-action-btn">
