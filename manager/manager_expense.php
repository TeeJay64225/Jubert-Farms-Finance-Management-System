...
<div class="container mt-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="../manager/manager_expense.php">
                ...
                <div class="mb-3">
                    ...
                    <?php if ($edit_data): ?>
                        <a href="../manager/manager_expense.php" class="btn btn-secondary">Cancel</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="../manager/manager_expenses_categories.php" class="btn btn-outline-primary btn-sm">
                        ...
                        <?php if (count($expenses) > 0): ?>
                            <?php foreach ($expenses as $expense): ?>
                                <tr>
                                    ...
                                    <td><?= $expense['notes'] ?></td>
                                    <td>
                                        <a href="../manager/manager_expense.php?edit=<?= $expense['expense_id'] ?>" class="btn btn-sm btn-primary">Edit</a>
                                        <a href="../manager/manager_expense.php?delete=<?= $expense['expense_id'] ?>" class="btn btn-sm btn-danger" 
