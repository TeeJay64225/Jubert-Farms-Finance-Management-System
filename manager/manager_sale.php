                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                              ...
                              <td>
                                    <a href='../manager/manager_sale.php?edit_id={$row['sale_id']}' class='btn btn-sm btn-primary'>Edit</a>
                                    <a href='../manager/manager_sale.php?delete_id={$row['sale_id']}' class='btn btn-sm btn-danger' 
