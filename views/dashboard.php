...
<nav class="navbar navbar-dark">
    <div class="container-fluid">
        ...
        <div class="d-flex">
            ...
            <div class="me-4">
                <a href="dashboard.php" class="btn btn-outline-light me-2"><i class="fas fa-chart-line"></i> Dashboard</a>
                <a href="sales.php" class="btn btn-outline-light me-2"><i class="fas fa-dollar-sign"></i> Sales</a>
                <a href="expenses.php" class="btn btn-outline-light me-2"><i class="fas fa-receipt"></i> Expenses</a>
                <a href="report.php" class="btn btn-outline-light"><i class="fas fa-file-alt"></i> Reports</a>
            </div>
